...
internal val logger: SkipLogger = SkipLogger(subsystem = "project.parent", category = "ProjectParent")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        ProjectParentAppDelegate.shared.onStart()
    }

    override fun onResume() {
        super.onResume()
        ProjectParentAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        ProjectParentAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        ProjectParentAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        ProjectParentAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        ProjectParentAppDelegate.shared.onLowMemory()
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            ProjectParentRootView().Compose(context = contentContext)
        }
    }
}
