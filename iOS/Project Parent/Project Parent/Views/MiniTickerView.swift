...
struct MiniTickerView: View {
    ...
    //@State var messagesToShow: [String] = ["Next bottle is due: \(UserDefaults.standard.string(forKey: "projectparent.nextBottleNotificationDateTime") ?? "N/A")", "Wake windows today: N/A ", "Average time between bottles: \(UtilFunctions().convertSecondsToHours (Int(UserDefaults.standard.double(forKey: "projectparent.averagetimebetweenbottles"))))" , "Food eaten today: N/A ", "Any medicene due: N/A", "Amount of wind: N/A", "Amount of nappy changes: N/A"]
                ...
                Text("\(msg)")
                    ...
                    .onReceive(timer) {_ in
                        ...
                        withAnimation
                        {
                            ...
                            {
                                msg = "Average time between bottles: \(UtilFunctions().convertSecondsToHours (Int(UserDefaults.standard.double(forKey: "projectparent.averagetimebetweenbottles"))))"
                            }
